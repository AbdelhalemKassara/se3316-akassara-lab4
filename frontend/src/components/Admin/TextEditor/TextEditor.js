 ...
 * 
 * copied from: https://github.com/facebook/draft-js/blob/main/examples/draft-0-10-0/rich/
 * 
 * This is copied and the changes I made to it are:
 * I switched it from the old way of using refs to the new way with .createRef;
 */
...
export default class TextEditor extends React.Component {
  ...
  render() {
    ...
    return (<>
      ...
      <div className="RichEditor-root">
        ...
        />
        <div className={className} onClick={() => this.editor.current.focus()}>
          <Editor
  ...
  }//the readOnly tag at the bottom is making it read only?/////////////////////////////////////////////////////////////////////////////////
}
