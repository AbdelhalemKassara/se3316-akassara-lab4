...
dateRecived DATETIME(2) NOT NULL,
note VARCHAR(1000),
PRIMARY KEY (id));

CREATE TABLE DMCAReviews(
DMCARequestID INT,
reviewID INT,
PRIMARY KEY(reviewID, DMCARequestID),
FOREIGN KEY (reviewID) REFERENCES playlistReview(reviewID) ON UPDATE CASCADE,
FOREIGN KEY (DMCARequestID) REFERENCES DMCARequest(id) ON UPDATE CASCADE
);

CREATE TABLE DMCANotice(
id INT AUTO_INCREMENT,
DMCARequestID INT NOT NULL,
dateSent DATETIME(2) NOT NULL,
note VARCHAR(1000),
PRIMARY KEY(id),
FOREIGN KEY (DMCARequestID) REFERENCES DMCARequest(id) ON UPDATE CASCADE
);
